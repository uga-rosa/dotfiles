...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-nvim-lsp", "cmp-cmdline", "cmp-path", "cmp-buffer", "cmp-dictionary", "cmp_luasnip" },
  ...
  previm = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/home/uga/.local/share/nvim/site/pack/packer/opt/previm",
...
vim.cmd [[noremap <silent> <Plug>(operator-replace) <cmd>lua require("packer.load")({'vim-operator-replace'}, { keys = "<lt>Plug>(operator-replace)", prefix = "" }, _G.packer_plugins)<cr>]]
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'previm', 'vim-maketable'}, { ft = "markdown" }, _G.packer_plugins)]]
time([[Defining lazy-load filetype autocommands]], false)
  -- Event lazy-loads
time([[Defining lazy-load event autocommands]], true)
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'denops.vim'}, { event = "CursorHold *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'translate.nvim', 'fuzzy-motion.vim', 'feline.nvim', 'open-browser.vim', 'vim-searchx'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'gina.vim', 'winresizer', 'nvim-tree.lua', 'vim-sandwich', 'vim-quickrun'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'vim-nightfly-guicolors', 'telescope.nvim', 'mason.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
