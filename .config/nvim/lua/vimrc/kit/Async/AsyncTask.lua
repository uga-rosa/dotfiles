...
---@field private status vimrc.kit.Async.AsyncTask.Status
...
---@param status vimrc.kit.Async.AsyncTask.Status
---@param value any
...
---@enum vimrc.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: vimrc.kit.Async.AsyncTask.Status, value: any }
