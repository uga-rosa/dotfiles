...
---@class vimrc.kit.App.Config
---@field private _cache vimrc.kit.App.Cache
---@field private _default vimrc.kit.App.Config.SchemaInternal
---@field private _global vimrc.kit.App.Config.SchemaInternal
---@field private _filetype table<string, vimrc.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, vimrc.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default? vimrc.kit.App.Config.Schema
...
---@param config vimrc.kit.App.Config.Schema
...
---@return fun(config: vimrc.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: vimrc.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: vimrc.kit.App.Config.Schema) }
