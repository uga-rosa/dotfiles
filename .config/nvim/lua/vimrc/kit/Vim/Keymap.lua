...
---@alias vimrc.kit.Vim.Keymap.Keys { keys: string, remap: boolean }
---@alias vimrc.kit.Vim.Keymap.KeysSpecifier string|{ keys: string, remap: boolean }

---@param keys vimrc.kit.Vim.Keymap.KeysSpecifier
---@return vimrc.kit.Vim.Keymap.Keys
...
---Send keys.
---@param keys vimrc.kit.Vim.Keymap.KeysSpecifier|vimrc.kit.Vim.Keymap.KeysSpecifier[]
...
function Keymap.to_sendable(callback)
  ...
  return Keymap.termcodes(('<Cmd>lua require("vimrc.kit.Vim.Keymap")._resolve(%s)<CR>'):format(unique_id))
end
