...
---@type fun(path: string, mode: integer): vimrc.kit.Async.AsyncTask
IO.fs_mkdir = Async.promisify(uv.fs_mkdir)

---@type fun(from: string, to: string, option?: { excl?: boolean, ficlone?: boolean, ficlone_force?: boolean }): vimrc.kit.Async.AsyncTask
IO.fs_copyfile = Async.promisify(uv.fs_copyfile)

---@type fun(path: string, flags: vimrc.kit.IO.UV.AccessMode, mode: integer): vimrc.kit.Async.AsyncTask
...
---@type fun(fd: userdata, chunk_size: integer, offset?: integer): vimrc.kit.Async.AsyncTask
IO.fs_read = Async.promisify(uv.fs_read)

---@type fun(fd: userdata, content: string, offset?: integer): vimrc.kit.Async.AsyncTask
