...
---@param encoding? vimrc.kit.LSP.PositionEncodingKind
...
---@param text string
---@param position vimrc.kit.LSP.Position
---@param from_encoding vimrc.kit.LSP.PositionEncodingKind
---@param to_encoding vimrc.kit.LSP.PositionEncodingKind
